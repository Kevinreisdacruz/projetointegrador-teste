...
<div class="container-admin">
    <div class="opcoes-admin">
        ...
        <div class="img-admin">
            ...
            <a href="<?=base_url('atualizarcatalogo');?>">
                <img src="assets/imagelogos/atualizar-catalogo.png" title="ATUALIZAR CATÁLOGO" alt="" width="65px">
            </a>
            ...
            <a href="<?=base_url('atualizarproduto');?>">
                <img src="assets/imagelogos/atualizar-produto.png" title="ATUALIZAR PRODUTO" alt="" width="65px">
            </a>
